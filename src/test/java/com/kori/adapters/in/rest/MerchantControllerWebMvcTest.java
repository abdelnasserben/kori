...
class MerchantControllerWebMvcTest {
    ...
    void should_update_merchant_status() throws Exception {
        ...
        var result = new UpdateMerchantStatusResult("merchant-123", "INACTIVE", "ACTIVE");
        ...
        mockMvc.perform(patch("/api/merchants/{merchantCode}/status", "merchant-123")
                ...
                .andExpect(jsonPath("$.subjectId").value("merchant-123"))
